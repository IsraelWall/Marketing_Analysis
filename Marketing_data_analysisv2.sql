...
--Incom Impact on online purchases-- V
...
--kids at home impact on online purchases -- V
SELECT 
    Kidhome,
    AVG(NumWebPurchases) AS Avg_Online_Purchases
FROM marketing_data
...
--teens at home impact on online purchases -- XV
SELECT 
    Teenhome,
    AVG(NumWebPurchases) AS Avg_Online_Purchases
FROM marketing_data
...
--Discounts Offered impact on online purchases --V
SELECT 
    NumDealsPurchases,
    AVG(NumWebPurchases) AS Avg_Online_Purchases
FROM marketing_data
...
-- education impact on online purchases --X
SELECT 
    Education,
    AVG(NumWebPurchases) AS Avg_Online_Purchases
FROM marketing_data
...
-- website visits impact on online purchases X
